package com.br.greenbank.domain.merchant;
...
public class Merchant {
    ...
    public Merchant(UUID merchantId, String companyName, String email, String password, String nationalId, Instant createdAt, Instant modifiedAt, Account account, List<Transaction> incomingTransactions) {
